...
@st.cache_data
def load_data():
    # Memuat data hanya dari file Product_stok_kota_final.csv
    df_product_stok_kota_final = pd.read_csv("Product_stok_kota_final.csv")
    return df_product_stok_kota_final

# Load data
product_favorit_akhir = load_data()
Product_stok_kota_final = load_data()
